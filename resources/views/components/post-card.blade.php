...
<article
  ...
  <div class="py-6 px-5">
    ...
    <div class="mt-8 flex flex-col justify-between">
      <header>
        <div class="space-x-2">
          <a href="route('getcategory')/{{ $post->category->slug }}"
      ...
      <footer class="flex justify-between items-center mt-8">
        ...
        <div>
          <a href="/posts/{{ $post->slug }}"
             class="transition-colors duration-300 text-xs font-semibold bg-gray-300 hover:bg-gray-400 rounded-full py-2 px-4"
          >Read More</a>
        </div>
      </footer>
    </div>
